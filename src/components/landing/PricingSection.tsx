          ...
          {tiers.map((tier, index) => (
            ...
            >
              ...
              <div className="p-5 md:p-6">
                ...
                <p className="text-muted-foreground text-xs md:text-sm mb-4 md:mb-6">{tier.subtitle}</p>

                <div className="mb-5 md:mb-6">
                  <p className="text-3xl md:text-4xl font-bold text-foreground">
                    {tier.fee}
                    <span className="text-muted-foreground text-sm md:text-base font-normal ml-1">fee</span>
                  </p>
                  <p className="text-muted-foreground text-xs md:text-sm mt-2">{tier.volume}</p>
                </div>
                ...
                <button className="w-full py-2 md:py-3 px-3 md:px-4 rounded-xl border border-white/20 text-foreground font-medium flex items-center justify-center gap-2 hover:bg-white/10 transition-all group-hover:border-primary/50">
                  Get Started
